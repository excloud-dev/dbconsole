  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-stone-400 focus-visible:ring-stone-400/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-stone-200 bg-background shadow-xs hover:bg-stone-100 hover:text-stone-700 dark:bg-stone-800 dark:border-stone-600 dark:hover:bg-stone-700 dark:hover:text-stone-200',
        secondary:
